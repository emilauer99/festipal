...
**Plans**: 6 plans in 5 Wellen — Welle 1 läuft echt parallel (Rename in `apps/mobile`, Endpunkt in
...
- [ ] 09-01-PLAN.md — `home` → `start`: harte Umbenennung in Route, msgid und UI, Geräteabnahme des Deep-Link-Pfads (NAV-03, D-19…D-21) · **nicht autonom** (Gerätecheck)
- [ ] 09-02-PLAN.md — `GET /festivals/:festivalId/friends`: Contract, Join über `my_festival` × `friendship`, SEC-02-Cross-Tenant-Spec (FRND-07, D-18) · **nicht autonom** (Einbahntür-Checkpoint)

**Wave 2** *(blockiert auf 09-01)*

- [ ] 09-03-PLAN.md — **Tracer**: Fünf-Tab-Festival-Navigator mit Layout-Gate, parametrisierte `FloatingNav`, `PlaceholderScreen` für die drei ehrlichen Platzhalter (NAV-01/NAV-02, D-01/D-05/D-10/D-12…D-14) · **nicht autonom** (Gerätecheck)

**Wave 3** *(blockiert auf 09-03)*

- [ ] 09-04-PLAN.md — app-weiter `AppHeader` mit drei Zuständen, zwei neue Outfit-Rollen, Ablösung des nativen Headers auf elf Screens (NAV-01, D-02…D-04/D-06/D-08) · **nicht autonom** (Gerätecheck)
...
- [ ] 09-06-PLAN.md — Cashless: `react-native-webview`, ursprungsbeschränkter WebView-Push-Screen, Kachel nur bei hinterlegter Adresse (NAV-01, D-09) · **nicht autonom** (Paket-Legitimitäts-Gate + nativer Rebuild)
