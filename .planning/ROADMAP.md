...
- [ ] 03-04-PLAN.md — (auth) real email-OTP screens + minimal (profile-setup) stub

**Wave 4** *(blocked on Wave 3)*

- [ ] 03-05-PLAN.md — festivals list (real `GET /festivals`) + gate-less save→enter + (festival) home placeholder
